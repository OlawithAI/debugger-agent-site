...
export default function HeroSection() {
  return (
    <section className="text-center py-20 px-4 bg-gradient-to-r from-gray-900 to-gray-800 text-white">
      ...
      <p className="text-lg md:text-xl max-w-2xl mx-auto mb-6">Instantly find, fix, and verify code issues using your personal AI code debugger in a secure sandbox. Stop wasting hours on bugs—start building with confidence on your IDE and Web.</p>
